    ...
    try {
      ...
      doctors.forEach(doc => {
        ...
        if (hasCustomImage) {
          ...
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/sania-sabahi.webp" alt="${doc.name}" class="dept-card-img" />`;
        } else if (nameLower.includes("rajesh bhakta")) {
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/rajesh%20bhakta.webp" alt="${doc.name}" class="dept-card-img" />`;
        } else if (nameLower.includes("bhagwan")) {
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/bhagwan.webp" alt="${doc.name}" class="dept-card-img" />`;
        } else if (nameLower.includes("ismail")) {
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/physician.webp" alt="${doc.name}" class="dept-card-img" />`;
        } else if (nameLower.includes("shiva kumar") || nameLower.includes("shivakumar")) {
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/surgeon.webp" alt="${doc.name}" class="dept-card-img" />`;
        } else if (nameLower.includes("nataraj r. rao") || nameLower.includes("nataraj rao")) {
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/founder.webp" alt="${doc.name}" class="dept-card-img" />`;
          ...
          cardMedia = `<img src="${SUPABASE_ASSETS_BUCKET_URL}/co-founder.webp" alt="${doc.name}" class="dept-card-img" />`;
        }
